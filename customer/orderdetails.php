      ...
      <div class="row">
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="Cash on Delivery" checked="false" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Cash on Delivery 
                        
                      </label>
                  </div> 
                  <div class="radio" >
                      <label >
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfe" value="eSewa" checked="false" data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Pay Via Esewa 
