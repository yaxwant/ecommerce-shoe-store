<?php
// Full path to config.php
require_once 'C:/xampp/htdocs/ECommerce/include/config.php';

// Or using relative paths with dirname
require_once dirname(__FILE__) . '/../ECommerce/include/config.php';
?>
