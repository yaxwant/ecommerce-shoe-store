        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >Pandey Singh E-Commerce</a>
            </div>
            <!-- /.navbar-header -->
...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        It's, <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="23px" height="25px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
                                ...
                                "post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="rows">
                                                    <img title="profile image" width="450" height="500" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
