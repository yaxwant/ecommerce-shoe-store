...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills" >
                <li><a href="#"><i class="fa fa-phone"></i> 9867456369</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> ecommerce@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
    ...
    <a href="<?php echo web_root ?>">
        <img src="images/home/logo.jpg" alt="" style="width: 80px; height: 80px;" />
    </a>
</div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>AY</span>-shop</h2>
              <p>For Your Ease, we present this site</p>
            </div>
          </div>
          <div class="col-sm-7">
    ...
    <div class="footer-widget">
      <div class="container">
        <p>Buy the best products from our store</p>
        <div class="row">
          <div class="col-sm-3">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>About Shopper</h2>
              <ul class="nav nav-pills nav-stacked flex" style="display: flex; flex-direction: column;">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="">Pandey Singh Ecommerce</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="">Pandey and Singh</a></span></p>
        </div>
      </div>
    </div>
